            ...
            foreach ( $tasks as $task ) { ?>
                <div class="swift-task-item" data-task-id="<?php echo esc_html($task->ID) ?>">
                    ...
                    <div class="swift-task-actions">
                        <a href="<?php echo esc_html(SWIFT_TODOLIST_BASE_URL) ?>/?task-action=view&task-id=<?php echo esc_html($task->ID) ?>" title="<?php echo esc_html__('View Task', 'swift-todolist');?>" class="view-task"><span class="dashicons dashicons-info-outline"></span></a>
                        <a href="#" title="<?php echo esc_html__('Edit Task', 'swift-todolist');?>" class="edit-task">
                            <span class="dashicons dashicons-edit-large"></span>
                        </a>
                        <a href="#" title="<?php echo esc_html__('Remove Task', 'swift-todolist');?>" class="remove-task">
                            <span class="dashicons dashicons-trash"></span>
                        </a>
                        <a href="#" title="<?php echo esc_html__('Update Task', 'swift-todolist');?>" class="update-task" style="display: none;">
                            <span class="dashicons dashicons-yes"></span>
                        </a>
                        <a href="#" title="<?php echo esc_html__('Cancel', 'swift-todolist');?>" class="cancel-task" style="display: none;">
