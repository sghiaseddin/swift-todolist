...
Use the `[sh_todolist]` shortcode on any page or post to display the task management interface.
...
You can display the to-do list by using the `[sh_todolist]` shortcode on any page or post.
